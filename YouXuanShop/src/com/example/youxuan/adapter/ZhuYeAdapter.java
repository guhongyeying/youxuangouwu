...
public class ZhuYeAdapter extends BaseAdapter {
		...
		private JinPinList datum;
		public ZhuYeAdapter(List<JinPinList> list,Context context) {
			super();
			this.list = list;
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			viewHolder.tx_now_price.setText(String.format(nowPrice,datum.getNow_price()));
			//Log.i("≤‚ ‘ÃÊªª∑˚", datum.getNow_price()+"");
			String originPrice=(String) viewHolder.tx_origin_price.getText();
			viewHolder.tx_origin_price.setText(String.format(originPrice,datum.getOrigin_price()));
			viewHolder.tx_title.setText(datum.getTitle());
			//…Ë÷√Õº∆¨
			viewHolder.imaview_list.setImageUrl(datum.getPic_url(), R.drawable.stub, R.drawable.stub);
