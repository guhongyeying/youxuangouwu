...
public class ZhutiXQAdapter extends BaseAdapter {
	...
	public ZhutiXQAdapter(List<DatumXianShi> list, Context context, int Rl) {
		super();
		this.Rl = Rl;
		this.list = list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(Rl, null);
